...
export function SavingsGoalsHeader({ monthLabel }: Props) {
  return (
    <div className="flex flex-wrap items-center justify-between gap-4">
      <div>
        <h1 className="text-2xl font-semibold">Savings Goals</h1>
        <p className="text-sm text-muted-foreground">Save for what matters most</p>
      </div>
      {/* Month navigation is a visual placeholder for now — switching months
          ...
          expenses, and recurring headers. */}
      <div
        aria-disabled="true"
